...
export default function CoinflipHighscoresPage() {
  const rawScores = useQuery(api.coinflipper.listScores, {
    limit: MAX_RESULTS,
  });
      ...
      <header className="flex flex-col gap-4">
        ...
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
            Top streaks submitted from the coinflip challenge. Scores are sorted
            by streak length, then by newest submissions.
          </p>
        </div>
      </header>
