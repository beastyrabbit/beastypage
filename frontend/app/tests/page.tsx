  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 py-16">
      ...
      <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="glass-card relative flex h-full flex-col gap-4 rounded-3xl border border-border/40 bg-background/70 p-6 text-sm text-muted-foreground">
          <div
            className="absolute inset-0 -z-10 rounded-3xl bg-gradient-to-br from-blue-400/15 via-transparent to-purple-400/15"
            aria-hidden
          />
          <div className="flex items-center justify-between text-xs uppercase tracking-wide text-muted-foreground/60">
            <span className="font-semibold text-foreground">
            ...
            <span className="rounded-full bg-blue-500/15 px-3 py-1 text-[11px] font-semibold text-blue-400">
              Sprites
            </span>
          </div>
          <p className="text-sm text-muted-foreground">
            Flip through every V3 layer image, recompose with blend modes
            on/off, and spot exactly where CatGenerator V2 diverges from the
            backend.
          </p>
          <div className="mt-auto flex gap-2 text-xs">
            <Link
        ...
        <div className="glass-card relative flex h-full flex-col gap-4 rounded-3xl border border-border/40 bg-background/70 p-6 text-sm text-muted-foreground">
          <div
            className="absolute inset-0 -z-10 rounded-3xl bg-gradient-to-br from-emerald-400/15 via-transparent to-sky-400/15"
            aria-hidden
          />
          <div className="flex items-center justify-between text-xs uppercase tracking-wide text-muted-foreground/60">
          ...
          <p className="text-sm text-muted-foreground">
            Run the backend renderer beside catGeneratorV2, collect pixel diffs,
            and inspect per-layer timings while you tweak Lifegen parity.
          </p>
          <div className="mt-auto flex gap-2 text-xs">
            <Link
              href="/dev/cat-v3"
        ...
        <div className="glass-card relative flex h-full flex-col gap-4 rounded-3xl border border-border/40 bg-background/70 p-6 text-sm text-muted-foreground">
          <div
            className="absolute inset-0 -z-10 rounded-3xl bg-gradient-to-br from-indigo-400/15 via-transparent to-amber-400/15"
            aria-hidden
          />
          <div className="flex items-center justify-between text-xs uppercase tracking-wide text-muted-foreground/60">
            <span className="font-semibold text-foreground">
          ...
          <p className="text-sm text-muted-foreground">
            Generate 10k–100k cats with both generators, flip between weighted
            and uniform multi-layer odds, and spot distribution drifts before
