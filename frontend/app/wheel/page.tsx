  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#090b13] text-foreground">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' opacity='0.12'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='2'/></filter><rect width='100%25' height='100%25' filter='url(%23n)'/></svg>')",
        }}
      />
