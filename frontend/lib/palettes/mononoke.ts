...
export const mononokePalette: PaletteCategory = {
  ...
  colors: {
    ...
    MONONOKE_LEAFGOLD: { multiply: [255, 235, 124] },
    ...
    MONONOKE_TAN: { multiply: [205, 196, 167] },
    MONONOKE_DARKFOREST: { multiply: [54, 96, 51] },
    MONONOKE_IRONTOWN: { multiply: [80, 60, 50] },
    MONONOKE_MORO: { multiply: [200, 195, 190] },
  },
};
