...
/** Build a flag SVG data URL using viewBox for scaling. */
function flagSvgUrl(viewBox: string, ...paths: string[]): string {
  const svg =
...
function kikkoCss(p: PatternDefinition): CSSPatternStyle {
  ...
  const bgStr = rgb(p.background);
  return {
    background: flagSvgUrl('0 0 28 49',
...
function ruyiCloudCss(p: PatternDefinition): CSSPatternStyle {
  ...
  const bgStr = rgb(p.background);
  return {
    background: flagSvgUrl('0 0 50 50',
      `<rect width="50" height="50" fill="${bgStr}"/>`,
...
function batikKawungCss(p: PatternDefinition): CSSPatternStyle {
  ...
  const bgStr = rgb(p.background);
  return {
    background: flagSvgUrl('0 0 32 26',
...
function batikParangCss(p: PatternDefinition): CSSPatternStyle {
  ...
  return {
    background: flagSvgUrl('0 0 24 40',
...
function karakusaCss(p: PatternDefinition): CSSPatternStyle {
  ...
  const bgStr = rgb(p.background);
  return {
    background: flagSvgUrl('0 0 80 40',
...
function mudclothCss(p: PatternDefinition): CSSPatternStyle {
  ...
  return {
    background: flagSvgUrl('0 0 48 48',
...
const CSS_GENERATORS: Record<PatternDefinition['type'], (p: PatternDefinition) => CSSPatternStyle> = {
  ...
  flag_scotland: () => ({ background: flagSvgUrl('0 0 512 512', '<path fill="#0065bd" d="M0 0h512v512H0z"/>', '<path stroke="#fff" stroke-width=".6" d="m0 0 5 3M0 3l5-3" transform="scale(102.4 170.66667)"/>') }),
  flag_jamaica: () => ({ background: flagSvgUrl('0 0 512 512', '<g fill-rule="evenodd"><path fill="#000001" d="m0 0 256 256L0 512zm512 0L256 256l256 256z"/><path fill="#090" d="m0 0 256 256L512 0zm0 512 256-256 256 256z"/><path fill="#fc0" d="M512 0h-47.7L0 464.3V512h47.7L512 47.7z"/><path fill="#fc0" d="M0 0v47.7L464.3 512H512v-47.7L47.7 0z"/></g>') }),
  flag_china: () => ({ background: flagSvgUrl('0 0 30 20', '<path fill="#ee1c25" d="M0 0h30v20H0z"/><path fill="#ff0" d="M5 2l1 3.1H9.2L7.1 7l.7 3L5 8.3 2.2 10l.7-3L.8 5.1H4z"/><path fill="#ff0" d="M10 1l.6 1.6h1.7l-1.3 1 .5 1.5L10 4.2l-1.5 1 .5-1.6-1.3-1h1.7z"/><path fill="#ff0" d="M12 4l.6 1.5h1.7l-1.3 1 .5 1.5-1.5-1-1.5 1 .5-1.5-1.3-1h1.7z"/><path fill="#ff0" d="M12 8l.6 1.5h1.7l-1.3 1 .5 1.5-1.5-1-1.5 1 .5-1.5-1.3-1h1.7z"/><path fill="#ff0" d="M10 11l.6 1.5h1.7l-1.3 1 .5 1.5-1.5-1-1.5 1 .5-1.5-1.3-1h1.7z"/>') }),
  flag_australia: () => ({ background: flagSvgUrl('0 0 512 512', '<path fill="#00008B" d="M0 0h512v512H0z"/><path fill="#fff" d="M256 0v32l-95 96 95 93.5V256h-33.5L127 162l-93 94H0v-34l93-93.5L0 37V0h31l96 94 93-94z"/><path fill="red" d="m92 162 5.5 17L21 256H0v-1.5zm62-6 27 4 75 73.5V256zM256 0l-96 98-2-22 75-76zM0 .5 96.5 95 67 91 0 24.5z"/><path fill="#fff" d="M88 0v256h80V0zM0 88v80h256V88z"/><path fill="red" d="M0 104v48h256v-48zM104 0v256h48V0z"/><path fill="#fff" d="m202 402.8-45.8 5.4 4.6 45.9-32.8-32.4-33 32.2 4.9-45.9-45.8-5.8L93 377.4 69 338l43.6 15 15.8-43.4 15.5 43.5 43.7-14.7-24.3 39.2 38.8 25.1z"/>') }),
