  ...
  colors: {
    ...
    FL_VIETNAM: {
      pattern: {
        ...
        stripes: [{ color: [218, 37, 29], width: 1, offset: 0 }],
      },
    },
    ...
    FL_NEW_ZEALAND: {
      pattern: {
        ...
        tileSize: 50,
        background: [0, 36, 125],
        stripes: [{ color: [0, 36, 125], width: 1, offset: 0 }],
      },
    },
    ...
    FL_MOROCCO: {
      pattern: {
        ...
        stripes: [{ color: [193, 39, 45], width: 1, offset: 0 }],
      },
    },
    ...
    FL_SAUDI: {
      pattern: {
        ...
        tileSize: 50,
        background: [0, 100, 0],
        stripes: [{ color: [0, 100, 0], width: 1, offset: 0 }],
      },
    },
