  ...
  colors: {
    ...
    SC_HEATHER_FINE: {
      pattern: {
        type: "gingham",
        tileSize: 6,
        background: [55, 68, 130],
        foreground: [210, 200, 225],
      },
    },
    SC_HEATHER_MED: {
      pattern: {
    ...
    SC_FAIRISLE_FINE: {
      pattern: {
        type: "argyle",
        tileSize: 8,
        background: [228, 220, 195],
        foreground: [45, 85, 135],
