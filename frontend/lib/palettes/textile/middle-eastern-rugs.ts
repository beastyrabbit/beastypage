  ...
  colors: {
    ...
    ME_KILIM_FINE: {
      pattern: {
        type: "basketweave",
        tileSize: 6,
        background: [172, 78, 38],
        foreground: [232, 222, 195],
      },
    },
    ME_KILIM_MED: {
      pattern: {
    ...
    ME_RIAD_FINE: {
      pattern: {
        type: "windowpane",
        tileSize: 6,
        background: [240, 238, 228],
        foreground: [22, 118, 112],
      },
    },
    ME_RIAD_MED: {
      pattern: {
