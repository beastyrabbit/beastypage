...
export const mushishiPalette: PaletteCategory = {
  ...
  colors: {
    ...
    MUSHISHI_SPIRIT: { multiply: [212, 228, 220] },
    MUSHISHI_MOSS: { multiply: [113, 144, 110] },
    MUSHISHI_SAGE: { multiply: [101, 122, 98] },
    MUSHISHI_GREYMIST: { multiply: [158, 166, 162] },
    MUSHISHI_DUSKBLUE: { multiply: [110, 122, 138] },
    MUSHISHI_BAMBOO: { multiply: [180, 190, 140] },
    MUSHISHI_TWILIGHT: { multiply: [46, 69, 69] },
    MUSHISHI_DAWN: { multiply: [220, 200, 180] },
  },
};
