...
const NAV_ITEMS = [
  { href: "/", label: "Hub", accent: "hub" },
  { href: "/gatcha", label: "Gatcha", accent: "gatcha" },
  { href: "/stream", label: "Stream Tools", accent: "stream" },
  { href: "/collection", label: "Collection", accent: "collection" },
  { href: "/personal", label: "Personal", accent: "personal" },
];
