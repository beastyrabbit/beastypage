...
export const CatNode = memo(function CatNode({
  cat,
  onClick,
  size = "md",
  showName = true,
  ...
  return (
    <button
      type="button"
      onClick={() => onClick?.(cat)}
      className={`group flex flex-col items-center gap-1 rounded-lg p-2 transition-all hover:bg-white/10 ${
        highlighted ? "ring-2 ring-amber-500 bg-amber-500/10" : ""
      }`}
    >
      <div
