...
class SpriteSheetLoader {
    constructor() {
        ...
        this.spriteSheetPath = '/pixel-cat-maker/public/sprites/';
    ...
    async init() {
        ...
        try {
            ...
            const indexJson = await fetchJson([
                '/pixel-cat-maker/src/assets/spritesIndex.json',
                'pixel-cat-maker/src/assets/spritesIndex.json'
            ]);
            const offsetJson = await fetchJson([
                '/pixel-cat-maker/src/assets/spritesOffsetMap.json',
                'pixel-cat-maker/src/assets/spritesOffsetMap.json'
            ]);
    ...
    async loadSpriteSheet(sheetName) {
        ...
        const tryPaths = [
            `${this.spriteSheetPath}${sheetName}.png`,        // absolute
            `pixel-cat-maker/public/sprites/${sheetName}.png`  // relative (for subpaths)
        ];
